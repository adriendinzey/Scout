...
Full column list: `migrations/0001_initial.sql`, which is the authority on the column types, on which columns are nullable and why, and on how much of
the 32-key-column index budget is left for amenity booleans.
